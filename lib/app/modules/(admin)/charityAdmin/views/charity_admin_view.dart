  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Charities Management'),
        centerTitle: true,
        actions: [
          // Refresh button
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () =>
                              controller.fetchCharitiesWithContributors(),
                          child: Text('Retry'),
                        )
                      ],
                    ),
...
// Widget Form Charity
  Widget _buildCharityForm(BuildContext context,
      {required bool isEdit, String? charityId}) {
    return Obx(() {
      return Column(
        children: [
          TextField(
          ...
          ElevatedButton(
            ...
            child: Obx(() => controller.isAddingCharity.value ||
                    controller.isUpdatingCharity.value
  ...
  void _showDeleteConfirmDialog(BuildContext context, String charityId) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete this charity?'),
        actions: [
          TextButton(
