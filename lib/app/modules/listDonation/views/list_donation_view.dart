...
class ListDonationView extends StatelessWidget {
  ...
  // Dialog functions
  void showSearchDialog(BuildContext context, List<CharityByCategory> currentCharities, Category? categoryId) {
    showDialog(
      context: context,
                    ...
                    onChanged: (value) {
                      if (value.isEmpty) {
                        ...
                        var filtered = currentCharities.where((charity) =>
                            charity.title.toLowerCase().contains(value.toLowerCase()));
  ...
  Widget build(BuildContext context) {
    ...
    if (categoryId?.id != null) {
      filteredCharities.value = charities.where((charity) => 
        charity.category.id == categoryId!.id).toList();
    } else {
